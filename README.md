...
Wei, H., Sun, Y., & Li, Y. (2025). **DeepSeek-OCR: Contexts Optical Compression**. *arXiv preprint arXiv:2510.18234*. [https://arxiv.org/abs/2510.18234](https://arxiv.org/abs/2510.18234)

> DeepSeek-OCR is a state-of-the-art vision-language model that achieves 97% OCR accuracy with 10× visual compression. It features a two-stage architecture (DeepEncoder + MoE decoder) and can process 200k+ pages per day on a single A100-40G GPU.
...
```bibtex
@inproceedings{Wei2025DeepSeekOCRCO,
  title={DeepSeek-OCR: Contexts Optical Compression},
  author={Haoran Wei and Yaofeng Sun and Yukun Li},
  year={2025},
  url={https://api.semanticscholar.org/CorpusID:282246871}
}
